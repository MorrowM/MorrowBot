...
rootComm = info (rootSubComm <**> helper)
    ( fullDesc
    <> (progDesc "MorrowBot")
    <> header "Get notified!"
    )
...
wordsComm = info (wordsSubComm <**> helper)
    ( fullDesc
...
reactionWatchComm = info (reactionSubWatch <**> helper)
    ( fullDesc
